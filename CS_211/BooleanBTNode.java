...
/******************************************************************************
* A <CODE>BooleanBTNode</CODE> provides a node for a binary tree. Each node 
...
*   <A HREF="../../../../edu/colorado/nodes/BooleanBTNode.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/nodes/BooleanBTNode.java </A>
*
* @author Michael Main 
...
public class BooleanBTNode
{
   ...
   /**
   * Initialize a <CODE>BooleanBTNode</CODE> with a specified initial data and links
