...
/*************************************y*****************************************
* A <CODE>BooleanLinkedQueue</CODE> is a queue of boolean values.
*
...
*   <A HREF="../../../../edu/colorado/collections/BooleanLinkedQueue.java">
...
******************************************************************************/
public class BooleanLinkedQueue implements Cloneable
{
   // Invariant of the BooleanLinkedQueue class:
   ...
   *   value must be type cast to an <CODE>BooleanLinkedQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone an BooleanLinkedQueue.
      BooleanLinkedQueue answer;
      BooleanNode[ ] cloneInfo;
      
      try
      {
         answer = (BooleanLinkedQueue) super.clone( );
      }
      ...
      cloneInfo = BooleanNode.listCopyWithTail(front);
   ...
   **/    
   public void insert(boolean item)
   {
       if (isEmpty( ))
       {  // Insert first item.
	  front = new BooleanNode(item, null);
	  rear = front;
       }
       else
