...
/******************************************************************************
* A <CODE>BooleanQueue</CODE> is a queue of boolean values.
*
...
*   <A HREF="../../../../edu/colorado/collections/BooleanQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/BooleanQueue.java
*   </A>
*
* @author Michael Main 
...
* @see ShortQueue
******************************************************************************/
public class BooleanQueue implements Cloneable
{
   // Invariant of the BooleanQueue class:
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for:
   *   <BR><CODE>new boolean[initialCapacity]</CODE>.
   **/   
   public BooleanQueue(int initialCapacity)
   {
   ...
   *   value must be type cast to a <CODE>BooleanQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone a BooleanQueue.
      BooleanQueue answer;
      
      try
      {
         answer = (BooleanQueue) super.clone( );
      }
      ...
      answer.data = (boolean [ ]) data.clone( );
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for: <CODE>new boolean[minimumCapacity]</CODE>. 
   **/
   public void ensureCapacity(int minimumCapacity)
   {
      ...
      if (data.length >= minimumCapacity)
         ...
         data = new boolean[minimumCapacity];
      else if (front <= rear)
      {  // Create larger array and copy data[front]...data[rear] into it.
         biggerArray = new boolean[minimumCapacity];
   ...
   *   arithmetic overflow.
   **/    
   public void insert(boolean item)
   {
   ...
   **/   
   public void trimToSize( )
   {
      ...
      {  // Create trimmed array and copy data[front]...data[rear] into it.
         trimmedArray = new boolean[manyItems];
