...
public class BooleanStack implements Cloneable
{
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for:
   *   <CODE>new boolean[initialCapacity]</CODE>.
   **/   
   ...
   *   value must be type cast to a <CODE>BooleanStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone a BooleanStack.
      BooleanStack answer;
      
      try
      {
         answer = (BooleanStack) super.clone( );
      }
