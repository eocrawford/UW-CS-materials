...
import edu.colorado.nodes.ByteNode;

/******************************************************************************
* A <CODE>ByteLinkedStack</CODE> is a stack of references to objects.
*
...
*   <A HREF="../../../../edu/colorado/collections/ByteLinkedStack.java">
...
******************************************************************************/
public class ByteLinkedStack implements Cloneable
{
   // Invariant of the ByteLinkedStack class:
   ...
   *   value must be type cast to a <CODE>ByteLinkedStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone a ByteLinkedStack.
      ByteLinkedStack answer;
      
      try
      {
         answer = (ByteLinkedStack) super.clone( );
      }
      ...
      answer.top = ByteNode.listCopy(top);
