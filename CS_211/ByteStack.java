...
/******************************************************************************
* A <CODE>ByteStack</CODE> is a stack of byte values.
*
...
*   <A HREF="../../../../edu/colorado/collections/ByteStack.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/ByteStack.java
*   </A>
*
* @author Michael Main 
...
* @see ShortStack
******************************************************************************/
public class ByteStack implements Cloneable
{
   // Invariant of the ByteStack class:
   ...
   *   value must be type cast to a <CODE>ByteStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for: <CODE>new byte[minimumCapacity]</CODE>. 
   **/
