...
*   <A HREF="../../../../edu/colorado/nodes/CharBTNode.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/nodes/CharBTNode.java </A>
*
* @author Michael Main 
...
{
   // Invariant of the CharBTNode class:
   //   1. Each node has one char value, stored in the instance
   //      variable data.
   //   2. The instance variables left and right are references to the node's
   //      left and right children.
   private char data;
   private CharBTNode left, right;   

   /**
   * Initialize a <CODE>CharBTNode</CODE> with a specified initial data and links
   ...
   **/   
   public CharBTNode(char initialData, CharBTNode initialLeft, CharBTNode initialRight)
   {
      data = initialData;
      left = initialLeft;
      right = initialRight;
   ...
   **/
   public CharBTNode removeLeftmost( )
   {
      if (left == null)
         return right;
      else
   ...
   *   this node.
   **/
   public void setLeft(CharBTNode newLeft)
   {                    
      left = newLeft;
   }
   ...
   *   this node.
   **/
   public void setRight(CharBTNode newRight)
   {                    
      right = newRight;
   }  
   ...
   **/ 
   public static CharBTNode treeCopy(CharBTNode source)
   {
      CharBTNode leftCopy, rightCopy;
      ...
      else
      {
         ...
         return new CharBTNode(source.data, leftCopy, rightCopy);
      }
   }
   ...
   **/ 
   public static int treeSize(CharBTNode root)
   {
      if (root == null)
         return 0;
      else
