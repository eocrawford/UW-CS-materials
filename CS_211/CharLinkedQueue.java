...
import edu.colorado.nodes.CharNode;

/******************************************************************************
* A <CODE>CharLinkedQueue</CODE> is a queue of char values.
*
...
*   <A HREF="../../../../edu/colorado/collections/CharLinkedQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/CharLinkedQueue.java
*   </A>
*
* @author Michael Main 
...
******************************************************************************/
public class CharLinkedQueue implements Cloneable
{
   // Invariant of the CharLinkedQueue class:
   ...
   *   value must be type cast to an <CODE>CharLinkedQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone an CharLinkedQueue.
      CharLinkedQueue answer;
      CharNode[ ] cloneInfo;
      
      try
      {
         answer = (CharLinkedQueue) super.clone( );
      }
      ...
      cloneInfo = CharNode.listCopyWithTail(front);
