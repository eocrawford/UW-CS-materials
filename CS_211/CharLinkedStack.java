...
/******************************************************************************
* A <CODE>CharLinkedStack</CODE> is a stack of references to objects.
*
...
*   <A HREF="../../../../edu/colorado/collections/CharLinkedStack.java">
...
******************************************************************************/
public class CharLinkedStack implements Cloneable
{
   // Invariant of the CharLinkedStack class:
   ...
   *   value must be type cast to a <CODE>CharLinkedStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone a CharLinkedStack.
      CharLinkedStack answer;
      
      try
      {
         answer = (CharLinkedStack) super.clone( );
      }
      ...
      answer.top = CharNode.listCopy(top);
   ...
   **/ 
   public int size( )   
   {
      return CharNode.listLength(top);
   }
