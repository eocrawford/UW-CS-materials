...
/******************************************************************************
* A <CODE>CharQueue</CODE> is a queue of char values.
*
...
*   <A HREF="../../../../edu/colorado/collections/CharQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/CharQueue.java
*   </A>
*
* @author Michael Main 
...
public class CharQueue implements Cloneable
{
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for:
   *   <CODE>new char[initialCapacity]</CODE>.
   **/   
   ...
   *   value must be type cast to a <CODE>CharQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for: <CODE>new char[minimumCapacity]</CODE>. 
   **/
