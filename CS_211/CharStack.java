...
/******************************************************************************
* A <CODE>CharStack</CODE> is a stack of char values.
*
...
*   <A HREF="../../../../edu/colorado/collections/CharStack.java">
...
public class CharStack implements Cloneable
{
   ...
   *   value must be type cast to a <CODE>CharStack</CODE> before it can be used.
   * @exception OutOfMemoryError
