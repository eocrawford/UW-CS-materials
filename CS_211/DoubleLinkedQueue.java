...
/******************************************************************************
* A <CODE>DoubleLinkedQueue</CODE> is a queue of double values.
*
...
*   <A HREF="../../../../edu/colorado/collections/DoubleLinkedQueue.java">
...
public class DoubleLinkedQueue implements Cloneable
{
   ...
   *   value must be type cast to an <CODE>DoubleLinkedQueue</CODE> before it can be used.
