...
/******************************************************************************
* A <CODE>DoubleQueue</CODE> is a queue of double values.
*
...
*   <A HREF="../../../../edu/colorado/collections/DoubleQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/DoubleQueue.java
*   </A>
*
* @author Michael Main 
...
* @see ShortQueue
******************************************************************************/
public class DoubleQueue implements Cloneable
{
   // Invariant of the DoubleQueue class:
   ...
   **/   
   public DoubleQueue(int initialCapacity)
   {
   ...
   *   value must be type cast to a <CODE>DoubleQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   ...
   **/ 
   ...
   {  // Clone a DoubleQueue.
      ...
      try
      {
         answer = (DoubleQueue) super.clone( );
      }
