...
/******************************************************************************
* A <CODE>FloatBTNode</CODE> provides a node for a binary tree. Each node 
...
*   <A HREF="../../../../edu/colorado/nodes/FloatBTNode.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/nodes/FloatBTNode.java </A>
*
* @author Michael Main 
...
* @see ShortBTNode
******************************************************************************/
public class FloatBTNode
{
   // Invariant of the FloatBTNode class:
   //   1. Each node has one float value, stored in the instance
   //      variable data.
   //   2. The instance variables left and right are references to the node's
   //      left and right children.
   private float data;
   private FloatBTNode left, right;   

   /**
   * Initialize a <CODE>FloatBTNode</CODE> with a specified initial data and links
   ...
   **/   
   public FloatBTNode(float initialData, FloatBTNode initialLeft, FloatBTNode initialRight)
   {
      data = initialData;
      left = initialLeft;
      right = initialRight;
   ...
   **/
   public FloatBTNode removeLeftmost( )
   {
      if (left == null)
         return right;
      else
   ...
   *   node (since that one node has now been removed).
   **/
   public FloatBTNode removeRightmost( )
   {
      if (right == null)
         return left;
      else
   ...
   *   this node.
   **/
   public void setLeft(FloatBTNode newLeft)
   {                    
      left = newLeft;
   }
   ...
   *   this node.
   **/
   public void setRight(FloatBTNode newRight)
   {                    
      right = newRight;
   }  
   ...
   **/ 
   public static FloatBTNode treeCopy(FloatBTNode source)
   {
      FloatBTNode leftCopy, rightCopy;
      ...
      else
      {
         ...
         return new FloatBTNode(source.data, leftCopy, rightCopy);
      }
   }
   ...
   **/ 
   public static int treeSize(FloatBTNode root)
   {
      if (root == null)
         return 0;
      else
