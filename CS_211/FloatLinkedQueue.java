...
/******************************************************************************
* A <CODE>FloatLinkedQueue</CODE> is a queue of float values.
*
...
*   <A HREF="../../../../edu/colorado/collections/FloatLinkedQueue.java">
...
******************************************************************************/
public class FloatLinkedQueue implements Cloneable
{
   // Invariant of the FloatLinkedQueue class:
   ...
   *   value must be type cast to an <CODE>FloatLinkedQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone an FloatLinkedQueue.
      FloatLinkedQueue answer;
      FloatNode[ ] cloneInfo;
      
      try
      {
         answer = (FloatLinkedQueue) super.clone( );
      }
      ...
      cloneInfo = FloatNode.listCopyWithTail(front);
