...
import edu.colorado.nodes.FloatNode;

/******************************************************************************
* A <CODE>FloatLinkedStack</CODE> is a stack of references to objects.
*
...
*   <A HREF="../../../../edu/colorado/collections/FloatLinkedStack.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/FloatLinkedStack.java
*   </A>
*
* @author Michael Main 
...
******************************************************************************/
public class FloatLinkedStack implements Cloneable
{
   // Invariant of the FloatLinkedStack class:
   ...
   *   value must be type cast to a <CODE>FloatLinkedStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone a FloatLinkedStack.
      FloatLinkedStack answer;
      
      try
      {
         answer = (FloatLinkedStack) super.clone( );
      }
      ...
      answer.top = FloatNode.listCopy(top);
   ...
   **/ 
   public int size( )   
   {
      return FloatNode.listLength(top);
   }
