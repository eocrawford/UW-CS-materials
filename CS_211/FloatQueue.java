...
/******************************************************************************
* A <CODE>FloatQueue</CODE> is a queue of float values.
*
...
*   <A HREF="../../../../edu/colorado/collections/FloatQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/FloatQueue.java
*   </A>
*
* @author Michael Main 
...
{
   // Invariant of the FloatQueue class:
   ...
   *   value must be type cast to a <CODE>FloatQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
