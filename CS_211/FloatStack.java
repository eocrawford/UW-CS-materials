...
/******************************************************************************
* A <CODE>FloatStack</CODE> is a stack of float values.
*
...
*   <A HREF="../../../../edu/colorado/collections/FloatStack.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/FloatStack.java
*   </A>
*
* @author Michael Main 
...
* @see ShortStack
******************************************************************************/
public class FloatStack implements Cloneable
{
   // Invariant of the FloatStack class:
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for:
   *   <CODE>new float[initialCapacity]</CODE>.
   **/   
   ...
   *   value must be type cast to a <CODE>FloatStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for: <CODE>new float[minimumCapacity]</CODE>. 
   **/
   ...
   **/    
   public void push(float item)
   {
      ...
      {
         // Float the capacity and add 1; this works even if manyItems is 0. However, in
   ...
   **/   
   public void trimToSize( )
   {
      ...
      {
         trimmedArray = new float[manyItems];
