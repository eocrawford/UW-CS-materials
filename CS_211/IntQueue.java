...
/******************************************************************************
* An <CODE>IntQueue</CODE> is a queue of int values.
*
...
*   <A HREF="../../../../edu/colorado/collections/IntQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/IntQueue.java
*   </A>
*
* @author Michael Main 
...
public class IntQueue implements Cloneable
{
   ...
   *   value must be type cast to an <CODE>IntQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
