...
/******************************************************************************
* A <CODE>LongBTNode</CODE> provides a node for a binary tree. Each node 
...
*   <A HREF="../../../../edu/colorado/nodes/LongBTNode.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/nodes/LongBTNode.java </A>
*
* @author Michael Main 
...
* @see ShortBTNode
******************************************************************************/
public class LongBTNode
{
   // Invariant of the LongBTNode class:
   //   1. Each node has one long value, stored in the instance
   //      variable data.
   //   2. The instance variables left and right are references to the node's
   //      left and right children.
   private long data;
   private LongBTNode left, right;   

   /**
   * Initialize a <CODE>LongBTNode</CODE> with a specified initial data and links
   ...
   **/   
   public LongBTNode(long initialData, LongBTNode initialLeft, LongBTNode initialRight)
   {
      data = initialData;
      left = initialLeft;
      right = initialRight;
   ...
   **/
   public LongBTNode removeLeftmost( )
   {
      if (left == null)
         return right;
      else
   ...
   *   node (since that one node has now been removed).
   **/
   public LongBTNode removeRightmost( )
   {
      if (right == null)
         return left;
      else
   ...
   *   this node.
   **/
   public void setLeft(LongBTNode newLeft)
   {                    
      left = newLeft;
   }
   ...
   *   this node.
   **/
   public void setRight(LongBTNode newRight)
   {                    
      right = newRight;
   }  
   ...
   **/ 
   public static LongBTNode treeCopy(LongBTNode source)
   {
      LongBTNode leftCopy, rightCopy;
      ...
      else
      {
         ...
         return new LongBTNode(source.data, leftCopy, rightCopy);
      }
   }
   ...
   **/ 
   public static int treeSize(LongBTNode root)
   {
      if (root == null)
         return 0;
      else
