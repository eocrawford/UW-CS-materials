...
/******************************************************************************
* A <CODE>LongLinkedQueue</CODE> is a queue of long values.
*
...
*   <A HREF="../../../../edu/colorado/collections/LongLinkedQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/LongLinkedQueue.java
*   </A>
*
* @author Michael Main 
...
******************************************************************************/
public class LongLinkedQueue implements Cloneable
{
   // Invariant of the LongLinkedQueue class:
   ...
   *   value must be type cast to an <CODE>LongLinkedQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone an LongLinkedQueue.
      LongLinkedQueue answer;
      LongNode[ ] cloneInfo;
      
      try
      {
         answer = (LongLinkedQueue) super.clone( );
      }
      ...
      cloneInfo = LongNode.listCopyWithTail(front);
