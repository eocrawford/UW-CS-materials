...
public class LongNode
{
   ...
   *   LongNode. 
   **/
   public void addNodeAfter(long item)   
   {
      link = new LongNode(item, link);
   }          
   ...
   **/ 
   public static LongNode listCopy(LongNode source)
   {
      LongNode copyHead;
      LongNode copyTail;
      ...
      copyHead = new LongNode(source.data, null);
      copyTail = copyHead;
   ...
   *   Indicates that there is insufficient memory for the new list.   
   **/
   public static LongNode[ ] listCopyWithTail(LongNode source)
   {
      LongNode copyHead;
      LongNode copyTail;
      LongNode[ ] answer = new LongNode[2];
   ...
   **/   
   public static int listLength(LongNode head)
   {
      LongNode cursor;
      int answer;
   ...
   *   Indicates that there is insufficient memory for the new list.    
   **/   
   public static LongNode[ ] listPart(LongNode start, LongNode end)
   {
      LongNode copyHead;
      LongNode copyTail;
      LongNode cursor;
      ...
      copyHead = new LongNode(start.data, null);
      copyTail = copyHead;
      cursor = start;
   ...
   **/   
   public static LongNode listPosition(LongNode head, int position)
   {
      LongNode cursor;
      int i;
   ...
   *   returned.     
   **/   
   public static LongNode listSearch(LongNode head, long target)
   {
      LongNode cursor;
   ...
   *   this node.
   **/
   public void setLink(LongNode newLink)
   {                    
      link = newLink;
   }
}
