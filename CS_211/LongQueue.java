...
/******************************************************************************
* A <CODE>LongQueue</CODE> is a queue of long values.
*
...
*   <A HREF="../../../../edu/colorado/collections/LongQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/LongQueue.java
*   </A>
*
* @author Michael Main 
...
{
   // Invariant of the LongQueue class:
   ...
   *   value must be type cast to a <CODE>LongQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
