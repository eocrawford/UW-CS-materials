...
/******************************************************************************
* A <CODE>LongStack</CODE> is a stack of long values.
*
...
*   <A HREF="../../../../edu/colorado/collections/LongStack.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/LongStack.java
*   </A>
*
* @author Michael Main 
...
{
   // Invariant of the LongStack class:
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for:
   *   <CODE>new long[initialCapacity]</CODE>.
   **/   
   ...
   *   value must be type cast to a <CODE>LongStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   ...
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for: <CODE>new long[minimumCapacity]</CODE>. 
   **/
   public void ensureCapacity(int minimumCapacity)
   {
      ...
      {
         biggerArray = new long[minimumCapacity];
   ...
   **/    
   public void push(long item)
   {
      ...
      {
         // Long the capacity and add 1; this works even if manyItems is 0. However, in
   ...
   **/   
   public void trimToSize( )
   {
      ...
      {
         trimmedArray = new long[manyItems];
