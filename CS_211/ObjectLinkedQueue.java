...
/******************************************************************************
* An <CODE>ObjectLinkedQueue</CODE> is a queue of references to objects.
*
...
*   <A HREF="../../../../edu/colorado/collections/ObjectLinkedQueue.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/ObjectLinkedQueue.java
*   </A>
*
* @author Michael Main 
...
******************************************************************************/
public class ObjectLinkedQueue implements Cloneable
{
   // Invariant of the ObjectLinkedQueue class:
   ...
   *   value must be type cast to an <CODE>ObjectLinkedQueue</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone an ObjectLinkedQueue.
