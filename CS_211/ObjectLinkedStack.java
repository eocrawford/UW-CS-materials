...
/******************************************************************************
* A <CODE>ObjectLinkedStack</CODE> is a stack of references to objects.
*
...
*   <A HREF="../../../../edu/colorado/collections/ObjectLinkedStack.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/collections/ObjectLinkedStack.java
*   </A>
*
* @author Michael Main 
...
******************************************************************************/
public class ObjectLinkedStack implements Cloneable
{
   // Invariant of the ObjectLinkedStack class:
   ...
   *   value must be type cast to a <CODE>ObjectLinkedStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   *   Indicates insufficient memory for creating the clone.
   **/ 
   public Object clone( )       
   {  // Clone a ObjectLinkedStack.
      ObjectLinkedStack answer;
      
      try
      {
         answer = (ObjectLinkedStack) super.clone( );
      }
