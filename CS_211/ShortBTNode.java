...
/******************************************************************************
* A <CODE>ShortBTNode</CODE> provides a node for a binary tree. Each node 
...
*   <A HREF="../../../../edu/colorado/nodes/ShortBTNode.java">
*   http://www.cs.colorado.edu/~main/edu/colorado/nodes/ShortBTNode.java </A>
*
* @author Michael Main 
...
{
   // Invariant of the ShortBTNode class:
   //   1. Each node has one short value, stored in the instance
   //      variable data.
   //   2. The instance variables left and right are references to the node's
   //      left and right children.
   private short data;
   private ShortBTNode left, right;   

   /**
   * Initialize a <CODE>ShortBTNode</CODE> with a specified initial data and links
   ...
   **/   
   public ShortBTNode(short initialData, ShortBTNode initialLeft, ShortBTNode initialRight)
   {
      data = initialData;
      left = initialLeft;
      right = initialRight;
   ...
   **/
   public ShortBTNode removeLeftmost( )
   {
      if (left == null)
         return right;
      else
   ...
   *   this node.
   **/
   public void setLeft(ShortBTNode newLeft)
   {                    
      left = newLeft;
   }
   ...
   *   this node.
   **/
   public void setRight(ShortBTNode newRight)
   {                    
      right = newRight;
   }  
   ...
   **/ 
   public static ShortBTNode treeCopy(ShortBTNode source)
   {
      ShortBTNode leftCopy, rightCopy;
      ...
      else
      {
         ...
         return new ShortBTNode(source.data, leftCopy, rightCopy);
      }
   }
   ...
   **/ 
   public static int treeSize(ShortBTNode root)
   {
      if (root == null)
         return 0;
      else
