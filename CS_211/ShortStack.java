...
/******************************************************************************
* A <CODE>ShortStack</CODE> is a stack of short values.
*
...
*   <A HREF="../../../../edu/colorado/collections/ShortStack.java">
...
* @see LongStack
******************************************************************************/
public class ShortStack implements Cloneable
{
   // Invariant of the ShortStack class:
   ...
   *   value must be type cast to a <CODE>ShortStack</CODE> before it can be used.
   * @exception OutOfMemoryError
   ...
   **/    
   public void push(short item)
   {
      ...
      {
         // Short the capacity and add 1; this works even if manyItems is 0. However, in
